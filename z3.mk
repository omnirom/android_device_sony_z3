...
$(call inherit-product, vendor/sony/shinano-z3-caf/z3-vendor.mk)
...
# Init specific
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/root/bin/init.blobs.sh:system/bin/init.blobs.sh \
    $(LOCAL_PATH)/rootdir/init.device.rc:root/init.device.rc \
    $(LOCAL_PATH)/root/build.prop.dual:system/build.prop.dual
